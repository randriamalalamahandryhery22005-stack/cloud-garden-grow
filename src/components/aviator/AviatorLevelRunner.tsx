      ...
      <div className="luxe-card p-4 space-y-3">
        <div className="space-y-1.5">
          <Label className="text-[10px] text-white/55 uppercase tracking-widest font-semibold flex items-center gap-1.5">
            <Clock className="w-3 h-3 luxe-gold" /> Heure du tour détecté
          </Label>
          <Input
            type="time"
            step={1}
      ...
      <div className="luxe-card luxe-card-emerald relative overflow-hidden p-4">
        ...
        <div className="relative flex items-center justify-between gap-3">
          <div>
            ...
            <h4 className="text-base font-black text-white">Niveau {outcome.level} · Résultats</h4>
            <p className="text-[10px] text-white/45 font-mono mt-0.5">{outcome.engine}</p>
          </div>
          <div className="text-right shrink-0">
        ...
        return (
          ...
          >
            ...
            <div className="relative flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] text-white/55 font-semibold">{row.label}</span>
            ...
            <div className="relative grid grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl border px-3 py-3 text-center" style={{ borderColor: `${km.color}44`, background: `${km.color}14` }}>
